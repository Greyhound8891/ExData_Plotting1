...
##plot1
        with(pwrcon, plot(Date_hms, Global_active_power, ylab = "Global Active Power (kilowatts)", xlab = "", type = "n"))
        lines(pwrcon$Date_hms,pwrcon$Global_active_power)
##plot2
        with(pwrcon, plot(Date_hms, Voltage, ylab = "Voltage", xlab = "datetime", type = "n"))
        lines(pwrcon$Date_hms,pwrcon$Voltage)
##plot3
...
##plot4
        with(pwrcon, plot(Date_hms, Global_reactive_power, xlab = "datetime", type = "n"))
        lines(pwrcon$Date_hms,pwrcon$Global_reactive_power)
